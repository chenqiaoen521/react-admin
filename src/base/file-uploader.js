...
class FileUpload extends React.Component{
    constructor(props) {
      ...
      this.commonChooseFile = this.commonChooseFile.bind(this)
      this.commonUpload = this.commonUpload.bind(this)
      this.IEBeforeChoose = this.IEBeforeChoose.bind(this)
      this.commonChange = this.commonChange.bind(this)
      this.IEChooseFile = this.IEChooseFile.bind(this)
    }
    /*根据props更新组件*/
    _updateProps(props) {
